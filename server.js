...
const SESSION_SECRET = process.env.SESSION_SECRET || 'grind-workout-secret-change-in-production';
const BCRYPT_ROUNDS = 10;

const pool = new Pool({
    connectionString: process.env.DATABASE_URL || 'postgresql://neondb_owner:npg_0KECSZYmauz1@ep-purple-union-an59hiw7-pooler.c-6.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require',
    ssl: {
